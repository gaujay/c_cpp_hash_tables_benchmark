...
template< typename blueprint > struct indivi_flat_wmap
{
  struct hash
  {
  ...
  using table_type = indivi::flat_wmap<
...
template<> struct indivi_flat_wmap< void >
{
  static constexpr const char *label = "flat_wmap";
  static constexpr const char *color = "rgb( 145, 125, 185 )";
